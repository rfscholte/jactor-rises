...
/**
 * A {@link HandlerInterceptorAdapter} that will give the action attribute to the the requested view and enable any of
 * its views to be able to send an html form action to the same request. It will also put the requested parameters on the
 * {@link ModelAndView}.
