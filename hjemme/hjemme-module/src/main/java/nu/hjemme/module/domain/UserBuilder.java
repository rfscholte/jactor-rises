...
public class UserBuilder extends DomainBuilder<User, MutableUser> {
    ...
    @Override
    protected User buildInstance(MutableUser mutableUser) {
        return new User(mutableUser);
    }

    @Override
    protected void validate(MutableUser mutableUser) {
