...
public class PersonBuilder extends DomainBuilder<Person, MutablePerson> {
    ...
    @Override
    protected Person buildInstance(MutablePerson mutablePerson) {
        return new Person(mutablePerson);
    }

    @Override
    protected void validate(MutablePerson mutablePerson) {
