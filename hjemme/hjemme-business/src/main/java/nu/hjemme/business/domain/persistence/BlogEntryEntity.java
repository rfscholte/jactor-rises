...
import static nu.hjemme.business.domain.persistence.meta.BlogEntryMetadata.BLOG;
import static nu.hjemme.business.domain.persistence.meta.BlogEntryMetadata.CREATED_BY;
import static nu.hjemme.business.domain.persistence.meta.BlogEntryMetadata.CREATION_TIME;
import static nu.hjemme.business.domain.persistence.meta.BlogEntryMetadata.CREATOR;
import static nu.hjemme.business.domain.persistence.meta.BlogEntryMetadata.ENTRY;
import static nu.hjemme.business.domain.persistence.meta.BlogEntryMetadata.ENTRY_ID;
