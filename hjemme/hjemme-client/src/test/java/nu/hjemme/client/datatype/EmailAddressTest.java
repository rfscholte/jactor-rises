...
public class EmailAddressTest {
    ...
    @Test
    public void willNotInitializeWhenPrefixIsNull() {
    ...
    @Test
    public void willNotInitializeWhenSuffixIsNull() {
        expectedException.expect(NullPointerException.class);
    ...
    @Test
    public void willInitializeWithFullEmailAddress() {
        assertThat(new EmailAddress("someone@somewhere"), is(notNullValue(), "full email address constructor"));
    }

    @Test
    public void willNotInitializeWhenFullEmailAddressIsNull() {
        expectedException.expect(NullPointerException.class);
    ...
    @Test
    public void willNotInitializeWithoutAtSignInConstructor() {
